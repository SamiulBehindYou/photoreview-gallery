...
@section('main')
    <div class="container mt-3 ">
        <div class="row justify-content-center d-flex mt-5">
            <div class="col-md-12">
                <a href="{{ route('photo.photo_index') }}" class="text-decoration-none text-dark ">
                    <i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp; <strong>Back to books</strong>
                </a>
                <div class="row mt-4">
                    <div class="col-md-6">
                        <img src="{{ asset('uploads/photos/'.$photo->image) }}" alt="" class="card-img-top">
                    </div>
                    <div class="col-md-6">
                        <h3 class="h2 mb-3">{{ $photo->title }}</h3>
                        <div class="h4 text-muted">{{ $photo->author }}</div>
